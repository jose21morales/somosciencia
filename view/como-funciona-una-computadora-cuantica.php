...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">¿Cómo funciona la computadora cuantica de Google?</h1>
	        <p class="blog__post-fecha">01 de Enero de 2022</p>
	    
	        <img src="../img/quantum-computer.jpg" alt="Foto del Articulo" class="blog__post-img">
