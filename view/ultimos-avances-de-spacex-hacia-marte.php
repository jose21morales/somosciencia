...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">Los ultimos avances de SpaceX para colonizar Marte</h1>
	        <p class="blog__post-fecha">15 de Enero de 2022</p>
	    
	        <img src="../img/spacex-mars.jpg" alt="Foto del Articulo" class="blog__post-img">
