...
<head>
	...
	<title>Somos Ciencia</title>
  	...
  	<link rel="stylesheet" type="text/css" href="../css/james-webb.css">
		...
		<div class="contenedor-div--flex-2">
			...
			<div class="nav" id="nav">
				<ul class="menu" id="menu">
		       		...
		       		<li class="menu__item"><a class="menu__link" id="menu__link-blog" href="">BLOG</a></li>

					 <li class="menu__item"><a class="menu__link active" id="menu__link-news" href="news.php">NOTICIAS</a></li>
