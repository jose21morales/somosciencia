...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">Conoce que esta haciendo la NASA con la basura espacial</h1>
	        <p class="blog__post-fecha">16 de Enero de 2022</p>
	    
	        <img src="../img/space-junk.jpeg" alt="Foto del Articulo" class="blog__post-img">
