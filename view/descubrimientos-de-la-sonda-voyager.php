...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">¡Mira lo que ha descubierto la sonda Voyager de la NASA!</h1>
	        <p class="blog__post-fecha">02 de Enero de 2022</p>
	    
	        <img src="../img/voyager.jpg" alt="Foto del Articulo" class="blog__post-img">
