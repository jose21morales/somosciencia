...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">¡Podria haber vida en Europa una de las lunas de Jupiter!</h1>
	        <p class="blog__post-fecha">01 de Enero de 2022</p>
	    
	        <img src="../img/moon.jpeg" alt="Foto del Articulo" class="blog__post-img">
