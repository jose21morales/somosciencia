...
<div class="container-blog__view background_white">
    ...
    <div class="blog__post-contenido">
        <div class="blog__post">
	        <h1 class="blog__post-titulo">¡Nuevos hallazgos de la sonda Parker que estudia el sol!</h1>
	        <p class="blog__post-fecha">25 de Diciembre de 2021</p>
	    
	        <img src="../img/parker.jpg" alt="Foto del Articulo" class="blog__post-img">
